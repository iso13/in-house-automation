Feature: Join Workplace
  ...
  Scenario: Successfully join workplace
    When I enter valid information to join workplace
    And I submit the form
    Then I should see a confirmation message
    And the workplace should be saved

  Scenario: join workplace using maximum input values
  ...
  Scenario: Attempt to join workplace with missing required fields
    When I submit the form with incomplete information
    Then I should see validation messages for required fields

  Scenario: Attempt to join workplace with invalid input types
    When I provide invalid data formats
    And I submit the form
    Then the system should reject the input
    And I should remain on the workplace page

  Scenario: Navigate away and return to resume join workplace
    When I start to join workplace
