Feature: Leave House
  ...
  Scenario: Successfully leave house
    When I enter valid information to leave house
    And I submit the form
    Then I should see a confirmation message
    And the house should be saved

  Scenario: leave house using maximum input values
  ...
  Scenario: Attempt to leave house with missing required fields
    When I submit the form with incomplete information
    Then I should see validation messages for required fields

  Scenario: Attempt to leave house with invalid input types
    When I provide invalid data formats
    And I submit the form
    Then the system should reject the input
    And I should remain on the house page

  Scenario: Navigate away and return to resume leave house
    When I start to leave house
